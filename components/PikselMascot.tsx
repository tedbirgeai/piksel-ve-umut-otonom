// components/PikselMascot.tsx
"use client";

/**
 * PİKSEL — Piksel ve Umut'un karakteri. Konsept görsele sadık: mavi voxel/küp robot,
 ...
 */
export default function PikselMascot({
  talking = false,
  size = 180,
  wave = false,
  pose = "idle",
  ...
  return (
    <div
      style={{
        ...
        placeItems: "center",
        animation: talking
          ? "pikselHop 0.5s ease-in-out infinite"
          : "pikselFloat 3.2s ease-in-out infinite",
        transformOrigin: "center bottom",
      }}
      aria-label="Piksel, Piksel ve Umut karakteri"
      role="img"
    >
      <svg viewBox="0 0 120 130" width={size} height={size} fill="none">
        <defs>
          <filter id="pikselGlow" x="-40%" y="-40%" width="180%" height="180%">
            ...
            transform:
              pose === "celebrate"
                ...
                : pose === "think"
                  ...
                  : "none",
            animation: wave
              ? "pikselWave 1.1s ease-in-out infinite"
              : talking
                ? "pikselArm 0.9s ease-in-out infinite"
                : "none",
          }}
        >
